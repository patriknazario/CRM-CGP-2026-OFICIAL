        ...
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40 px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
             <div className="text-right hidden md:block">
                <p className="text-sm font-bold text-slate-700">Setembro 2026</p>
                <p className="text-xs text-slate-500">Última atualização: Hoje, 14:30</p>
             </div>
                           ...
                           >
                              ...
                              <div className="flex items-start gap-3 pl-2">
                                 <div className={`mt-0.5 ${
                                   notif.tipo === 'urgent' ? 'text-red-500' : 
