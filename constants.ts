...
export const VENDEDORAS_MOCK: Vendedora[] = [
  { id: 'v1', nome: 'Ana', vendasTotais: 154000, metaIndividual: 120000, metaMensal: 15000, metaTrimestral: 45000, metaAnual: 180000, performance: 128, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v2', nome: 'Andreia', vendasTotais: 98000, metaIndividual: 120000, metaMensal: 37500, metaTrimestral: 112500, metaAnual: 450000, performance: 81, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v3', nome: 'Ariane', vendasTotais: 132000, metaIndividual: 120000, metaMensal: 15000, metaTrimestral: 45000, metaAnual: 180000, performance: 110, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v4', nome: 'Elaine', vendasTotais: 110000, metaIndividual: 120000, metaMensal: 37500, metaTrimestral: 112500, metaAnual: 450000, performance: 91, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v5', nome: 'Elis', vendasTotais: 180000, metaIndividual: 120000, metaMensal: 15000, metaTrimestral: 45000, metaAnual: 180000, performance: 150, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v6', nome: 'Halana', vendasTotais: 85000, metaIndividual: 120000, metaMensal: 15000, metaTrimestral: 45000, metaAnual: 180000, performance: 70, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v7', nome: 'Larissa', vendasTotais: 125000, metaIndividual: 120000, metaMensal: 15000, metaTrimestral: 45000, metaAnual: 180000, performance: 104, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v8', nome: 'Najara', vendasTotais: 145000, metaIndividual: 120000, metaMensal: 15000, metaTrimestral: 45000, metaAnual: 180000, performance: 120, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
  { id: 'v9', nome: 'Viviane', vendasTotais: 165000, metaIndividual: 120000, metaMensal: 20000, metaTrimestral: 60000, metaAnual: 240000, performance: 137, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jessica' },
];
